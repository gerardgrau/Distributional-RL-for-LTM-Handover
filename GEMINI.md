...
- **Hardware Sympathy**: Environment is heavily optimized for **CPU-bound NumPy vectorization**. CPU mode is 2.5x faster than XPU for this workload. Default execution device is centralized in `configs/config.yaml`.
