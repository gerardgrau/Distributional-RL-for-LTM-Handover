...
appears only as further quantiles populate the head and is largely complete once a
few are present: sweeping $N$ at the study setting, the handover-failure rate falls
from $0.64$/min at $N{=}1$ to $0.55$/min by $N{=}3$ and changes little thereafter
(handover rate $6.0$ to $5.3$/min), while the reward per decision stays flat. Their
...
\begin{table}[htbp]
\caption{The hard-CVaR risk dial ($1{,}000$ episodes, three seeds), from mild
