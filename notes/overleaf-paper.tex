...
\author{\IEEEauthorblockN{Gerard Grau Garcia, Marga Cabrera Bean, Josep Vidal,
and Ainna Yue Moreno-Locubiche }
\IEEEauthorblockA{gerard.grau.garcia@estudiantat.upc.edu, \{marga.cabrera, josep.vidal, ainna.yue.moreno\}@upc.edu}
...
baseline---evaluated in the same simulator---on every user-facing and safety KPI
...
\begin{itemize}
  ...
  already improves the mobility and reliability KPIs over scalar DQN at equal
  ...
  hand-tuned LTM baseline (run in our own simulator) and the contextual
...
swept on the final backbone (Sections~\ref{sec:setup},~\ref{sec:results-dist})
and leave the operating point within noise. (iv)~We explore CVaR and its spectral
...
Also many thanks to Ainna Yue Moreno Locubiche, for providing the code necessary to perform the simulation on the LTM, and to help me debug the simulation.

% =====================================================================
\begin{thebibliography}{00}
\bibitem{cmab_ho} A. Y. Moreno-Locubiche \emph{et al.}, ``Contextual bandits and reconfigurable intelligent surfaces for predictive LTM handover decisions,'' in \emph{Proc. ICC}, 2026.
